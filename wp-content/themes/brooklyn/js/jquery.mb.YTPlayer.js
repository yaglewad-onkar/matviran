  ...
  jQuery.mbYTPlayer = {
    ...
    defaults        : {
      ...
      /**
       ...
       default container class for the player @United
       */
      container_class: "playerBox",

      /**
       filters enabled bolean
       default optional filters for the player @United
       */
    ...
    buildPlayer: function (options) {
      ...
      return this.each(function () {
        ...
        /**
         create the wrapper
         Modified by UnitedThemes @United
         */
        YTPlayer.wrapper = jQuery('<div/>').attr('id', 'wrapper_' + YTPlayer.id).css({
          ...
          overflow : 'hidden',
          opacity  : 0
        }).addClass('mbYTP_wrapper').addClass(YTPlayer.opt.container_class);
        ...
        /* Modified by UnitedThemes @United */
        if( YTPlayer.opt.filters_enabled ) {

          playerBox.addClass('ut-video-section-player-with-filter');
