...
$side_background_title_uniqid = uniqid('ohio-custom-');

$side_background_title_settings = NorExtraParser::VC_color_to_CSS( $side_background_title_color, 'color:{{color}};' );
$side_background_title_settings .= NorExtraParser::VC_typo_to_CSS( $side_background_title_typo );

NorExtraParser::VC_typo_custom_font( $side_background_title_typo );


$_style_block = '';
if ( $side_background_title_settings ) {
	$_style_block .= '#' . $side_background_title_uniqid . ' {';
	$_style_block .= $side_background_title_settings;
	$_style_block .= '}';
}
...
if ( $side_background_title ) {
	$side_text_classes = 'vc-bg-side-text';
	...
	$output .= '<div class="' . $side_text_classes . '" id="' . $side_background_title_uniqid . '">' . $side_background_title . '</div>';
}
// !Ohio modification
